...
public class CircleCornerLinearLayout extends LinearLayout {
    ...
    public CircleCornerLinearLayout(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);
        if (attrs != null) {
            TypedArray ta = context.obtainStyledAttributes(attrs, R.styleable.CircleCornerLayout);
            float radius = ta.getDimension(R.styleable.CircleCornerLayout_radius, 0);
            topLeftRadius = ta.getDimension(R.styleable.CircleCornerLayout_topLeftRadius, radius);
            topRightRadius = ta.getDimension(R.styleable.CircleCornerLayout_topRightRadius, radius);
            bottomLeftRadius = ta.getDimension(R.styleable.CircleCornerLayout_bottomLeftRadius, radius);
            bottomRightRadius = ta.getDimension(R.styleable.CircleCornerLayout_bottomRightRadius, radius);
            ta.recycle();
        }
